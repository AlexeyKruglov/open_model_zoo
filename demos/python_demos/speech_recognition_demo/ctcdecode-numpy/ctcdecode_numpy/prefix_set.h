...
public:
  PrefixSet() = default;
  PrefixSet(const PrefixSet&) = delete;
  PrefixSet& operator=(const PrefixSet&) = default;
  ...
  // the vocabulary).
  bool append_character(int character, PrefixSetState& state);
